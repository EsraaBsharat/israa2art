const Portfolio = function() {
	...
	function makeWordCloud(words) {
		$('.teaching-domains').jQCloud(words, {delay: 20});
	}
	...
	function typeAnimation() {
		Typed.new("#writing-text", {
			strings: [
				"I am a professional artist.","With more than 8 years of drawing on the skin", "selling professional original art.", "My art is being recognised far and wide.","I'm here to paint...", "to capture beauty and give it some 'umph!.", "Handicrafter."
			],
